...
cars.put('/:id', (req, res) => {
    ...
    const indexOfCar = carArray.findIndex(c => c.id === id);
    carArray[indexOfCar].make = req.body.make;
    carArray[indexOfCar].model = req.body.model;
    carArray[indexOfCar].year = req.body.year;
